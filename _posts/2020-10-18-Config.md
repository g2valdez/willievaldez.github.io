---
layout: post
title: (WIP) Making a Config System
...
Making the config thread safe is as simple as changing the definition of the members of the config struct. Note the changes in the `#define ConfigKey` macros:
